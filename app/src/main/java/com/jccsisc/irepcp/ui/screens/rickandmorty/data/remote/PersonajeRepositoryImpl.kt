...
import com.jccsisc.irepcp.ui.screens.rickandmorty.data.remote.dto.personaje.toPersonaje
import com.jccsisc.irepcp.ui.screens.rickandmorty.data.remote.dto.personajes.toListPersonajes
 ...
 */
class PersonajeRepositoryImpl @Inject constructor(private val api: RickAndMortyApi) : PersonajeRepository {
